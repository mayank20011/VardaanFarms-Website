...
const TermsAndCondition = ({ totalPaddingToGive }) => {
  return (
    ...
    >
      <div className="mx-auto max-w-[1400px] lg:w-3/4 md:w-11/12 px-4 md:px-0 min-h-screen text-black py-8 flex flex-col gap-6">
        <h1 className="text-3xl sm:text-4xl font-bold text-green-600">Terms and Conditions</h1>
        <p>Last updated: March 05, 2025</p>
        <p>
          Please read these terms and conditions carefully before using Our
          Service.
        </p>
        <h2 className="text-3xl text-green-600 font-semibold">Interpretation and Definitions</h2>
        ...
        <ul className="pl-4 list-disc flex flex-col gap-4">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Vardaan Farms, Office no 19, star
        ...
        <h2 className="text-3xl text-green-600 font-semibold">Acknowledgment</h2>
        <p>
        ...
        <h2 className="text-3xl text-green-600 font-semibold">Links to Other Websites</h2>
        <p>
        ...
        <h2 className="text-3xl text-green-600 font-semibold">Termination</h2>
        <p>
        ...
        <h2 className="text-3xl text-green-600 font-semibold">Limitation of Liability</h2>
        <p>
        ...
        <h2 className="text-3xl text-green-600 font-semibold">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
        <p>
        ...
        <h2 className="text-3xl text-green-600 font-semibold">Governing Law</h2>
        <p>
        ...
        <h2 className="text-3xl text-green-600 font-semibold">Disputes Resolution</h2>
        <p>
          If You have any concern or dispute about the Service, You agree to
          first try to resolve the dispute informally by contacting the Company.
        </p>
        <h2 className="text-3xl text-green-600 font-semibold">Severability and Waiver</h2>
        ...
        <h3 className="text-2xl">Waiver</h3>
        <p>
        ...
        <h2 className="text-3xl text-green-600 font-semibold">Translation Interpretation</h2>
        <p>
          These Terms and Conditions may have been translated if We have made
          them available to You on our Service. You agree that the original
          English text shall prevail in the case of a dispute.
        </p>
        <h2 className="text-3xl text-green-600 font-semibold">Changes to These Terms and Conditions</h2>
        <p>
        ...
        <h2 className="text-3xl text-green-600 font-semibold">Contact Us</h2>
        <p>
          If you have any questions about these Terms and Conditions, You can
          contact us:
        </p>
        <ul className="flex flex-col gap-4 list-disc pl-4">
          <li>By email: <span className="text-green-600">hello@vardaanfarms.com</span></li>
        </ul>
      </div>
    </div>
  );
